...
export default function ClientPage() {
  ...
  const projects = [
    {
      id: 1,
      title: "MARVELLEX CRYPTO",
      description: " Marvellex is a big, welcoming digital family built on cool new technology called blockchain. This technology helps make things secure, transparent, and fair for everyone..",
      image: "mlxc.png/?height=600&width=800",
      tags: ["Solidity", "Etherium", "Next.js", "MongoDB", "WebSockets"],
      demoUrl: "https://marvellex.com/",
      repoUrl: "#",
    },
    {
      id: 2,
      title: "MY REAL ESTATE GURU",
      description: "My Real Estate Guru – your trusted guide to navigating the global real estate market. Whether you're looking to buy, sell, rent, or list properties.",
      image: "/real-estate.png?height=600&width=800",
      tags: ["Next.js", "GoLang", "ElasticSearch", "AWS"],
      demoUrl: "https://myrealestate.guru/",
      repoUrl: "#",
    },
    {
      id: 3,
      title: "HAPVIDER PORTAL",
      description: "A complete full feature rich with AI automation toolkit for the digital marketing agency that empowers local businesses to dominate online.",
      image: "/hapvidor.png?height=600&width=800",
      tags: ["AI", "GoLang", "PostgreSQL", "Stripe", "React"],
      demoUrl: "https://hapvider.com/",
      repoUrl: "#",
    },
  ]
  ...
  const articles = [
    {
      id: 1,
      title: "Why I Ditched Node.js for Golang:",
      excerpt:
        "Standing Out as a Junior Developer: The Harsh Reality of a Saturated Job Market",
      date: "Feb 15, 2025",
      readTime: "8 min read",
      category: "Go",
    },
    {
      ...
      excerpt: "Go's infamous error handling has caught quite the attention from outsiders to the programming language, often touted as one of the language's most questionable design decisions.",
      date: "Feb 28, 2025",
